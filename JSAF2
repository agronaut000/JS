...
maskBack.onclick = function () {
	...
	document.getElementsByClassName('expert-user_details-list')[0].childNodes[1].childNodes[1].innerText == phone) {
		document.getElementsByClassName('ant-modal-wrap')[0].style.display = ''
		document.getElementsByClassName('ant-modal-mask')[0].style.display = ''
...
function startTimer() {
	...
	if(document.getElementsByClassName('ant-modal-wrap')[0] !== undefined) {
